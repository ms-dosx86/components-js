## API Report File for "@ms-dosx86/components-core"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts
import type { AudioCaptureOptions } from '@ms-dosx86/livekit-client';
import { BehaviorSubject } from 'rxjs';
import { ChatMessage } from '@ms-dosx86/livekit-client';
import { ConnectionQuality } from '@ms-dosx86/livekit-client';
import { ConnectionState } from '@ms-dosx86/livekit-client';
import { DataPacket_Kind } from '@ms-dosx86/livekit-client';
...
import type { ParticipantEventCallbacks } from '@ms-dosx86/livekit-client/dist/src/room/participant/Participant';
import type { ParticipantKind } from '@ms-dosx86/livekit-client';
import type { ParticipantPermission } from '@livekit/protocol';
import type { PublicationEventCallbacks } from '@ms-dosx86/livekit-client/dist/src/room/track/TrackPublication';
...
import type { RoomEventCallbacks } from '@ms-dosx86/livekit-client/dist/src/room/Room';
import type { ScreenShareCaptureOptions } from '@ms-dosx86/livekit-client';
import { SendTextOptions } from '@ms-dosx86/livekit-client';
import { setLogLevel as setLogLevel_2 } from '@ms-dosx86/livekit-client';
import type { TextStreamInfo } from '@ms-dosx86/livekit-client/dist/src/room/types';
import { Track } from '@ms-dosx86/livekit-client';
import { TrackEvent as TrackEvent_2 } from '@ms-dosx86/livekit-client';
import { TrackPublication } from '@ms-dosx86/livekit-client';
import type { TrackPublishOptions } from '@ms-dosx86/livekit-client';
import { TranscriptionSegment } from '@ms-dosx86/livekit-client';
import type { VideoCaptureOptions } from '@ms-dosx86/livekit-client';
...
export function createChatObserver(
  ...
  [message: ChatMessage, participant?: LocalParticipant | RemoteParticipant | undefined]
>;
...
export function trackEventSelector<T extends TrackEvent_2>(
  ...
  event: T,
): Observable<Parameters<PublicationEventCallbacks[Extract<T, keyof PublicationEventCallbacks>]>>;
