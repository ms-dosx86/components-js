## API Report File for "@ms-dosx86/components-react"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts
import { AudioAnalyserOptions } from '@ms-dosx86/livekit-client';
import { AudioCaptureOptions } from '@ms-dosx86/livekit-client';
...
import { ConnectionState as ConnectionState_2 } from '@ms-dosx86/livekit-client';
import { CreateLocalTracksOptions } from '@ms-dosx86/livekit-client';
import { DataPublishOptions } from '@ms-dosx86/livekit-client';
import { DisconnectReason } from '@ms-dosx86/livekit-client';
...
import { LocalAudioTrack } from '@ms-dosx86/livekit-client';
import { LocalParticipant } from '@ms-dosx86/livekit-client';
import { LocalTrack } from '@ms-dosx86/livekit-client';
import { LocalTrackPublication } from '@ms-dosx86/livekit-client';
...
import { LocalVideoTrack } from '@ms-dosx86/livekit-client';
...
import { ParticipantEvent } from '@ms-dosx86/livekit-client';
...
import { RemoteAudioTrack } from '@ms-dosx86/livekit-client';
import { RemoteParticipant } from '@ms-dosx86/livekit-client';
import { Room } from '@ms-dosx86/livekit-client';
import { RoomConnectOptions } from '@ms-dosx86/livekit-client';
import { RoomEvent } from '@ms-dosx86/livekit-client';
import { RoomOptions } from '@ms-dosx86/livekit-client';
import { ScreenShareCaptureOptions } from '@ms-dosx86/livekit-client';
import { SendTextOptions } from '@ms-dosx86/livekit-client';
...
import { TrackProcessor } from '@ms-dosx86/livekit-client';
import { TrackPublication } from '@ms-dosx86/livekit-client';
...
import { TranscriptionSegment } from '@ms-dosx86/livekit-client';
import { VideoCaptureOptions } from '@ms-dosx86/livekit-client';
...
export const LiveKitRoom: (
  props: React_2.PropsWithChildren<LiveKitRoomProps> & React_2.RefAttributes<HTMLDivElement>,
) => React_2.ReactNode;
...
export function useAudioWaveform(
  trackOrTrackReference?: LocalAudioTrack | RemoteAudioTrack | TrackReferenceOrPlaceholder_4,
...
export function usePagination(
  itemPerPage: number,
  trackReferences: TrackReferenceOrPlaceholder_4[],
): {
...
export function useRemoteParticipant(
  identifier: ParticipantIdentifier_2,
...
// @public
export function useTrackToggle<T extends ToggleSource_2>({
  source,
  onChange,
  initialState,
  captureOptions,
  ...
  toggle:
    ...
    | ((
        forceState?: boolean,
        captureOptions?: CaptureOptionsBySource_2<T> | undefined,
...
// @public (undocumented)
export interface UseTrackToggleProps<T extends ToggleSource_2>
  extends Omit<TrackToggleProps<T>, 'showIcon'> {}

// @alpha (undocumented)
export function useTrackTranscription(
  trackRef: TrackReferenceOrPlaceholder_4 | undefined,
...
export function useTrackVolume(
  trackOrTrackReference?: LocalAudioTrack | RemoteAudioTrack | TrackReference_3,
